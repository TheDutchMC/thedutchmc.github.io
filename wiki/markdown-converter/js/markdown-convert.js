...
(function () {
    ...
    (i.bullet = /(?:[*+-]|\d+\.)/),
        ...
        (a.prototype.token = function (a, b) {
            for (var c, d, e, f, g, h, j, k, l, a = a.replace(/^ +$/gm, ""); a; )
                if (((e = this.rules.newline.exec(a)) && ((a = a.substring(e[0].length)), e[0].length > 1 && this.tokens.push({ type: "space" })), (e = this.rules.code.exec(a))))
                    ...
                    for (a = a.substring(e[0].length), f = e[2], this.tokens.push({ type: "list_start", ordered: f.length > 1 }), e = e[0].match(this.rules.item), c = !1, l = e.length, k = 0; l > k; k++)
                        (h = e[k]),
                            (j = h.length),
                            (h = h.replace(/^ *([*+-]|\d+\.) +/, "")),
                            ~h.indexOf("\n ") && ((j -= h.length), (h = this.options.pedantic ? h.replace(/^ {1,4}/gm, "") : h.replace(new RegExp("^ {1," + j + "}", "gm"), ""))),
                            this.options.smartLists && k !== l - 1 && ((g = i.bullet.exec(e[k + 1])[0]), f === g || (f.length > 1 && g.length > 1) || ((a = e.slice(k + 1).join("\n") + a), (k = l - 1))),
                            (d = c || /\n\n(?!\s*$)/.test(h)),
                            k !== l - 1 && ((c = "\n" === h[h.length - 1]), d || (d = c)),
                            this.tokens.push({ type: d ? "loose_item_start" : "list_item_start" }),
                            this.token(h, !1),
                            this.tokens.push({ type: "list_item_end" });
                    this.tokens.push({ type: "list_end" });
                } else if ((e = this.rules.html.exec(a))) (a = a.substring(e[0].length)), this.tokens.push({ type: this.options.sanitize ? "paragraph" : "html", pre: "pre" === e[1] || "script" === e[1], text: e[0] });
    ...
    (j._inside = /(?:\[[^\]]*\]|[^\]]|\](?=[^\[]*\]))*/),
        ...
        (j.normal = g({}, j)),
        (j.pedantic = g({}, j.normal, { strong: /^__(?=\S)([\s\S]*?\S)__(?!_)|^\*\*(?=\S)([\s\S]*?\S)\*\*(?!\*)/, em: /^_(?=\S)([\s\S]*?\S)_(?!_)|^\*(?=\S)([\s\S]*?\S)\*(?!\*)/ })),
        (j.gfm = g({}, j.normal, { escape: e(j.escape)("])", "~|])")(), url: /^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/, del: /^~~(?=\S)([\s\S]*?\S)~~/, text: e(j.text)("]|", "~]|")("|", "|https?://|")() })),
        (j.breaks = g({}, j.gfm, { br: e(j.br)("{2,}", "*")(), text: e(j.gfm.text)("{2,}", "*")() })),
        (b.rules = j),
            ...
            for (var b, c, e, f, g = ""; a; )
                if ((f = this.rules.escape.exec(a))) (a = a.substring(f[0].length)), (g += f[1]);
                    ...
                    (a = a.substring(f[0].length)),
                        "@" === f[2] ? ((c = this.mangle(":" === f[1][6] ? f[1].substring(7) : f[1])), (e = this.mangle("mailto:") + c)) : ((c = d(f[1])), (e = c)),
                        (g += '<a href="' + e + '">' + c + "</a>");
                ...
                else if ((f = this.rules.text.exec(a))) (a = a.substring(f[0].length)), (g += d(f[0]));
                else if (a) throw new Error("Infinite loop on byte: " + a.charCodeAt(0));
            return g;
        }),
        (b.prototype.outputLink = function (a, b) {
            return "!" !== a[0][0]
                ? '<a href="' + d(b.href) + '"' + (b.title ? ' title="' + d(b.title) + '"' : "") + ">" + this.output(a[1]) + "</a>"
                : '<img src="' + d(b.href) + '" alt="' + d(a[1]) + '"' + (b.title ? ' title="' + d(b.title) + '"' : "") + ">";
        }),
        ...
        (b.prototype.mangle = function (a) {
            for (var b, c = "", d = a.length, e = 0; d > e; e++) (b = a.charCodeAt(e)), Math.random() > 0.5 && (b = "x" + b.toString(16)), (c += "&#" + b + ";");
            return c;
        }),
        ...
        (c.prototype.tok = function () {
            switch (this.token.type) {
                ...
                case "code":
                    ...
                    return (
                        this.token.escaped || (this.token.text = d(this.token.text, !0)),
        ...
        (h.defaults = { gfm: !0, tables: !0, breaks: !1, pedantic: !1, sanitize: !1, smartLists: !1, silent: !1, highlight: null, langPrefix: "lang-" }),
        (h.Parser = c),
        (h.parser = c.parse),
        (h.Lexer = a),
        (h.lexer = a.lex),
    ...
    (function (a) {
        "use strict";
        a("html").addClass("md-hidden-load"),
            (a.md = function (b) {
            ...
            (a.md.config = { title: null, useSideMenu: !0, lineBreaks: "gfm", additionalFooterText: "", anchorCharacter: "&para;", tocAnchor: "[ &uarr; ]" }),
            (a.md.gimmicks = []),
            (a.md.stages = []),
            (a.md.mainHref = ""),
            (a.md.inPageAnchor = ""),
            (a.md.loglevel = { TRACE: 10, DEBUG: 20, INFO: 30, WARN: 40, ERROR: 50, FATAL: 60 }),
        ...
        a.Stage = function (c) {
            ...
            return (
                ...
                (d.executeSubscribedFn = function (e) {
                    var f = a.Deferred();
                    d.outstanding.push(f),
                        a.md.util.wait(2500).done(function () {
                            "resolved" !== f.state() &&
                                (b.fatal("Timeout reached for done callback in stage: " + d.name + ". Did you forget a done() call in a .subscribe() ?"), b.fatal("stage " + c + " failed running subscribed function: " + e));
                        });
                    var g = function () {
                        f.resolve();
                    };
                ...
                (d.run = function () {
                    (d.started = !0),
                        a(d.events).each(function (a, b) {
                            d.executeSubscribedFn(b);
                        }),
                        0 === d.outstanding.length && d.resolve(),
                        a.when
                            .apply(a, d.outstanding)
                            .done(function () {
                                d.resolve();
                            })
                            .fail(function () {
    ...
    (function (a) {
        ...
        function e() {
            ...
            a.md.stage("init").subscribe(function (c) {
                ...
                a.md.stage("transform").subscribe(function (b) {
                    var c = a.md.mainHref.lastIndexOf("/"),
                        d = a.md.mainHref.substring(0, c + 1);
                    (a.md.baseUrl = d), b();
                }),
        ...
        function f(b) {
            function c() {
                return a("a").filter(function () {
                    var b = a(this).attr("href"),
                        c = a(this).toptext(),
                        d = a.md.util.hasMarkdownFileExtension(b),
                        e = "include" === c,
                        f = c.startsWith("preview:");
                    return (e || f) && d;
                });
            }
            function e(b, c) {
            ...
            var f = c(),
                g = a.md.util.countDownLatch(f.length);
            g.always(function () {
                b.resolve();
            }),
                f.each(function (b, c) {
                    var f = a(c),
                        h = f.attr("href"),
                        i = f.toptext();
                    a.ajax({ url: h, dataType: "text" })
                        .done(function (b) {
                            var c = a(d(b));
                            if (i.startsWith("preview:")) {
                                var g = parseInt(i.substring(8), 10) || 3,
                                    j = e(c, g);
        ...
        function i() {
            a.md.stage("init").subscribe(function (b) {
                ...
                a.md.stage("postgimmick").subscribe(function (b) {
                    var c = a("#md-menu a").length,
                        d = a("#md-menu .navbar-brand").eq(0).toptext().trim().length > 0;
        ...
        function l(b) {
            (a.md.mainHref = b),
                ...
                a.each(a.md.gimmicks, function (b, c) {
                    void 0 !== c.load &&
                        a.md.stage("load").subscribe(function (a) {
                            c.load(), a();
                        });
                }),
                a.md.stage("ready").subscribe(function (b) {
    ...
    (function (a) {
        var b = {
            ...
            hasMarkdownFileExtension: function (b) {
                var c = [".md", ".markdown", ".mdown"],
                    d = !1,
                    e = b.toLowerCase().split("#")[0];
                return (
        ...
        (a.md.util = a.extend({}, a.md.util, b)),
            ...
            (a.md.util.repeatUntil = function (b, c, d) {
                function e(b, c, d) {
                    return 0 === d
                        ...
                        : c()
                        ? void f.resolve()
                        : void a.md.util.wait(b).always(function () {
                              e(b, c, d - 1);
                          });
                }
                d = d || 10;
    ...
    (function ($) {
        ...
        function loadScript(a) {
            var b = a.module,
                ...
                i = $.Deferred();
            checkLicense(e, b),
                log.debug("subscribing " + b.name + " to start: " + f + " end in: " + g),
                $.md.stage(f).subscribe(function (a) {
                    c.startsWith("//") || c.startsWith("http")
        ...
        function findModuleByTrigger(a) {
            var b;
            return (
                $.each(linkTriggers, function (c, d) {
        ...
        function getGimmickLinkParts($link) {
            ...
            var href = $.trim($link.attr("href")),
                r = new RegExp(/gimmick:\s*([^(\s]*)\s*(\(\s*{?(.*)\s*}?\s*\))*/i),
        ...
        function subscribeLinkTrigger(a, b, c) {
            log.debug("Subscribing gimmick " + c.module.name + " to stage: " + c.stage),
                $.md.stage(c.stage).subscribe(function (d) {
                    (b.options = b.options || {}),
                        jQuery.contains(document.documentElement, a[0]) || (log.error("LINK IS NOT IN THE DOM ANYMORE: "), console.log(a)),
                        log.debug("Running gimmick " + c.module.name),
                        c.callback(a, b.options, b.href, d),
                        d();
                });
        }
    ...
    (function (a) {
        ...
        function h() {
            function b(b, c) {
                var d = a.md.config.anchorCharacter,
                    e = a('<span class="anchor-highlight"><a>' + d + "</a></span>");
                e.find("a").attr("href", c), e.hide();
                var f = !1;
                b.mouseenter(function () {
                    (f = !0),
                        a.md.util.wait(300).then(function () {
                            f && e.fadeIn(200);
                        });
                }),
            ...
            function c(b) {
                if (a.md.config.useSideMenu !== !1 && "H2" === b.prop("tagName")) {
                    ...
                    if ("" !== c) {
                        var d = a('<a class="visible-xs visible-sm jumplink" href="#md-page-menu">' + c + "</a>");
                        d.click(function (b) {
                            b.preventDefault(), a("body").scrollTop(a("#md-page-menu").position().top);
                        }),
                            0 === b.parents("#md-menu").length && d.insertAfter(b);
                    }
                }
            }
            a("h1,h2,h3,h4,h5,h6")
        ...
        var i = {
            createBasicSkeleton: function () {
                b(),
                    ...
                    d(),
                    h(),
                    a.md.stage("all_ready").subscribe(function (b) {
                        "" !== a.md.inPageAnchor &&
                            a.md.util.wait(500).then(function () {
        ...
        (a.md.publicMethods = a.extend({}, a.md.publicMethods, i)),
            (a.md.scrollToInPageAnchor = function (b) {
                ...
                a(".md-inpage-anchor").each(function () {
                    if (!c) {
                        var d = a(this),
                            e = d.toptext(),
                            f = a.md.util.getInpageAnchorText(e);
                        if (b === f) {
    ...
    (function (a) {
        ...
        function b() {
            if (!(a("#md-menu").length <= 0)) {
                o = "top";
                var b = a("#md-menu").children(),
                    c = "";
                (c += '<div id="md-main-navbar" class="navbar navbar-default navbar-fixed-top" role="navigation">'),
                    (c += '<div class="navbar-header">'),
                    (c += '<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">'),
                    (c += '<span class="sr-only">Toggle navigation</span>'),
                    (c += '<span class="icon-bar"></span>'),
                    (c += '<span class="icon-bar"></span>'),
                    (c += '<span class="icon-bar"></span>'),
                    (c += "</button>"),
                    (c += '<a class="navbar-brand" href="#"></a>'),
                    (c += "</div>"),
                    (c += '<div class="collapse navbar-collapse navbar-ex1-collapse">'),
                ...
                a("#md-menu h1").remove(),
                    a("a.navbar-brand").text(f),
                    a("#md-body").css("margin-top", "70px"),
                    a.md.stage("pregimmick").subscribe(function (a) {
                        d(), a();
                    });
            }
        }
        ...
        function e() {
            if (0 !== a("#md-menu a").length) {
                var c = a("#md-menu");
                c.find('> a[href=""]').attr("data-toggle", "dropdown").addClass("dropdown-toggle").attr("href", "").append('<b class="caret"/>'),
                    c.find("ul").addClass("dropdown-menu"),
                    c.find("ul li").addClass("dropdown"),
                    a("#md-menu hr").each(function (b, c) {
                        var d = a(c),
                            e = d.prev(),
                            f = d.next();
                    ...
                    a("#md-menu hr").replaceWith(a('<li class="divider-vertical"/>')),
                    a("#md-menu > a").wrap("<li />"),
                    a("#md-menu ul").each(function (b, c) {
                        var d = a(c);
                        d.appendTo(d.prev()), d.parent("li").addClass("dropdown");
                    }),
                    a("#md-menu li.dropdown")
                        .find("h1, h2, h3")
                        .each(function (b, c) {
                            var d = a(c),
                                e = d.toptext(),
                                f = a('<li class="dropdown-header" />');
        ...
        function g() {
            ...
            if ((b.children().remove(), !(b.length <= 1))) {
                ...
                var e = a('<div id="md-page-menu" />'),
                    g = 70;
                
                //No longer supported in Bootstrap 4.
                //e.affix({ offset: 130 }), e.css("top", g);
                var h = a('<div class="panel panel-default"><ul class="list-group"/></div>'),
                    i = h.find("ul");
                e.append(h),
                    b.each(function (b, c) {
                        var d = a(c),
                            e = a('<li class="list-group-item" />'),
                            f = a("<a />");
                        f.attr("href", a.md.util.getInpageAnchorHref(d.toptext())),
                            f.click(function (b) {
                                b.preventDefault();
                                var c = a(this),
                                    d = a.md.util.getInpageAnchorText(c.toptext());
        ...
        function h() {
            a("#md-title").wrap('<div class="container" id="md-title-container"/>'),
                a("#md-title").wrap('<div class="row" id="md-title-row"/>'),
                a("#md-menu").wrap('<div class="container" id="md-menu-container"/>'),
                a("#md-menu").wrap('<div class="row" id="md-menu-row"/>'),
                a("#md-content").wrap('<div class="container" id="md-content-container"/>'),
                a("#md-content").wrap('<div class="row" id="md-content-row"/>'),
                a("#md-body").wrap('<div class="container" id="md-body-container"/>'),
                a("#md-body").wrap('<div class="row" id="md-body-row"/>'),
                a("#md-title").addClass("col-md-12"),
                a("#md-content").addClass("col-md-12");
        }
        function i() {
        ...
        function k() {
            ...
            b.each(function () {
                ...
                c.hasClass("md-floatenv")
                    ? 1 === d.length
                        ? b(d, '<div class="col-sm-8" />')
                        : 2 === d.length
                        ? b(d, '<div class="col-sm-4" />')
                        : b(d, '<div class="col-sm-2" />')
                    : 1 === d.length
                    ? b(d, '<div class="col-sm-12" />')
                    : 2 === d.length
                    ? b(d, '<div class="col-sm-6" />')
                    : 3 === d.length
                    ? b(d, '<div class="col-sm-4" />')
                    : 4 === d.length
                    ? b(d, '<div class="col-sm-3" />')
                    : b(d, '<div class="col-sm-2" />'),
                    c.addClass("row");
            });
        }
        function l() {
            a("iframe.md-external").not(".md-external-nowidth").attr("width", "450").css("width", "450px"),
                a("iframe.md-external").not(".md-external-noheight").attr("height", "280").css("height", "280px"),
                a("div.md-external").not(".md-external-noheight").css("height", "280px"),
                a("div.md-external").not(".md-external-nowidth").css("width", "450px");
        }
        function m() {
            var b = "";
        ...
        (a.mdbootstrap = function (b) {
            ...
            (a.mdbootstrap.events = []),
            (a.mdbootstrap.bind = function (b, c) {
            ...
            p = {
                bootstrapify: function () {
                    h(),
                        ...
                        i(),
                        k(),
                        a("table").addClass("table").addClass("table-bordered"),
                        a.md.stage("pregimmick").subscribe(function (b) {
            ...
            return (
                a("p").filter(function () {
                    ...
                    a(e).each(function (e, h) {
                        var i = g.text().toLowerCase(),
                            j = new RegExp(h + "(:|!)+.*", "i"),
                            k = "none";
                        null !== i.match(j) && (a.inArray(h, b) >= 0 ? (k = "note") : a.inArray(h, c) >= 0 ? (k = "warning") : a.inArray(h, d) >= 0 && (k = "hint"), f.push({ p: g, alertType: k }));
                    });
                }),
                f
            );
        ...
        var c = {
            colorbox: function () {
                ...
                return b.each(function () {
                    var b = a(this),
                        d = "gallery-group-" + c++;
                    b.find("a.md-image-selfref img").parents("a").colorbox({ rel: d, opacity: 0.75, slideshow: !0, maxWidth: "95%", maxHeight: "95%", scalePhotos: !0, photo: !0, slideshowAuto: !1 });
                });
            },
        };
    ...
    (function (a) {
        "use strict";
        function b(b, c, d) {
            var e = a('<div id="myCarousel" class="carousel slide"></div>'),
                f = a('<div class="carousel-inner"/>');
            ...
            a.each(d.split(","), function (b, c) {
                ...
                e.append(f),
                e.append('<a class="carousel-control left" href="#myCarousel" data-slide="prev">&lsaquo;</a>'),
                e.append('<a class="carousel-control right" href="#myCarousel" data-slide="next">&rsaquo;</a>'),
                b.replaceWith(e);
        }
        var c = {
            name: "Themes",
            version: a.md.version,
            once: function () {
        ...
        var c = !1,
            d = function (b, d) {
                var e = { identifier: "" },
                    f = a.extend(e, d),
                    g = a(
                        '<div id="disqus_thread" class="md-external md-external-noheight md-external-nowidth" ><a href="http://disqus.com" class="dsq-brlink">comments powered by <span class="logo-disqus">Disqus</span></a></div>'
                    );
                return (
                    g.css("margin-top", "2em"),
                    b.each(function (b, d) {
                        if (c !== !0) {
                            c = !0;
                            var e = a(d),
                            ...
                            void 0 !== h &&
                                h.length > 0 &&
                                (e.remove(),
                                a("#md-content").append(g),
                                a("#disqus_thread").length > 0 &&
                                    !(function () {
                                        var a,
    ...
    (function (a) {
        function b(b, c) {
            var d = { layout: "standard", showfaces: !0 },
                f = a.extend({}, d, c);
            return (
                "boxcount" === f.layout && (f.layout = "box_count"),
                "buttoncount" === f.layout && (f.layout = "button_count"),
                b.each(function (b, c) {
                    var d = a(c),
                        g = d.attr("href");
                    a("body").append(e);
        ...
        var c = window.navigator.userLanguage || window.navigator.language,
            ...
            h = {
                ...
                version: a.md.version,
                once: function () {
                    a.md.linkGimmick(this, "facebooklike", b), a.md.registerScript(this, g, { license: "APACHE2", loadstage: "postgimmick", finishstage: "all_ready" });
                },
            };
    ...
    (function (a) {
        ...
        function b(b, c) {
            return b.each(function (b, d) {
                var e = a(d),
                    f = { color: "red", position: "right" },
                    g = a.extend({}, f, c),
                    h = g.color,
                    i = g.position,
                    j = "https://s3.amazonaws.com/github/ribbons/forkme_";
                "red" === h && (j += i + "_red_aa0000.png"),
                    "green" === h && (j += i + "_green_007200.png"),
                    "darkblue" === h && (j += i + "_darkblue_121621.png"),
                    "orange" === h && (j += i + "_orange_ff7600.png"),
                    "white" === h && (j += i + "_white_ffffff.png"),
                    "gray" === h && (j += i + "_gray_6d6d6d.png");
                var k = e.attr("href"),
                    l = 0,
    ...
    (function (a) {
        ...
        function b(b, c, d) {
            return (
                ...
                b.each(function (b, c) {
                    var e = a(c),
                        f = a('<div class="gist_here" data-id="' + d + '" />');
    ...
    (function (a, b, c, d) {
        ...
        function e(b) {
            var e, f, g;
            if (-1 !== b.indexOf('rel="stylesheet"')) (f = a(b).attr("href")), -1 === a.inArray(f, k) && (a("head").append(b), k.push(f));
            else if (-1 !== b.indexOf('id="gist')) {
...
!(function (a) {
    function b(b, d) {
        ...
        return e.each(function (b, e) {
            var f = a(e),
                g = { zoom: 11, marker: !0, scrollwheel: !1, maptype: "roadmap" },
                h = a.extend({}, g, d);
    ...
    var d = "http://maps.google.com/maps/api/js?sensor=false&callback=googlemapsReady",
        e = {
            name: "googlemaps",
            version: a.md.version,
            once: function () {
                (googlemapsLoadDone = a.Deferred()),
                    a.md.linkGimmick(this, "googlemaps", b),
                    a.md.registerScript(this, d, { license: "EXCEPTION", loadstage: "skel_ready", finishstage: "bootstrap" }),
                    a.md.stage("bootstrap").subscribe(function (b) {
                        a.md.triggerIsActive("googlemaps")
    ...
    (function (a) {
        ...
        function b(b, c) {
            return b.each(function (b, d) {
                ...
                if ((g.attr("src", f), e.replaceWith(g), c.width && g.css("width", c.width), c.height)) g.css("height", c.height);
                else {
                    var h = function () {
                        var b = g.offset(),
                            c = a(window).height(),
    ...
    (function (a) {
        ...
        var e = a.md.getLogger(),
            f = function (c) {
                ...
                ("bootstrap" === c.name && f) || (a("style[id*=bootstrap]").remove(), a('<link rel="stylesheet" type="text/css">').attr("href", a.md.prepareLink(c.url)).appendTo("head")),
                    c.inverse === !0
                        ? (a("#md-main-navbar").removeClass("navbar-default"), a("#md-main-navbar").addClass("navbar-inverse"))
                        : (a("#md-main-navbar").addClass("navbar-default"), a("#md-main-navbar").removeClass("navbar-inverse"));
            },
            g = function (b, d, e) {
                (d.name = d.name || e),
                    b.each(function (b, e) {
                ...
                return (
                    ...
                    d.each(function (c, d) {
                        ...
                        i.click(function (a) {
                            ...
                            g.eq(1).append(h),
                            g.eq(1).append('<li class="divider" />'),
                            g.eq(1).append('<li><a href="http://www.bootswatch.com">Powered by Bootswatch</a></li>'),
                            e.replaceWith(g);
                    })
                );
            },
    ...
    (function (a) {
        var b = a.md.prepareLink("platform.twitter.com/widgets.js"),
            ...
            d = {
                ...
                version: a.md.version,
                once: function () {
                    a.md.linkGimmick(this, "twitterfollow", e), a.md.registerScript(this, c, { license: "EXCEPTION", loadstage: "postgimmick", finishstage: "all_ready" });
                },
            };
        a.md.registerGimmick(d);
        var e = function (b) {
        ...
        function b() {
            ...
            b.each(function () {
                ...
                if (void 0 !== c) {
                    ...
                    if (e && 11 === e[1].length) {
                        var f = e[1],
                            g = a('<iframe class="md-external" frameborder="0" allowfullscreen></iframe>');
    ...
    (function (a) {
        "use strict";
        function b(b, c) {
            var d = { type: "class", style: "plain", direction: "LR", scale: "100" },
                e = a.extend({}, d, c);
            return b.each(function (b, c) {
                var d = a(c),
                    f = "http://yuml.me/diagram/",
                    g = d.attr("href"),
                    h = d.attr("title");
        ...
        var c = {
            ...
            version: a.md.version,
            once: function () {
                a.md.linkGimmick(this, "yuml", b), a.md.registerScript(this, "", { license: "LGPL", loadstage: "postgimmick", finishstage: "all_ready" });
            },
        };
        a.md.registerGimmick(c);
    })(jQuery);